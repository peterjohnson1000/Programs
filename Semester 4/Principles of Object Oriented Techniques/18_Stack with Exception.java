// Construct a Stack Class with proper exception handling mechanisms. While doing a Pop
// operation, if the stack is empty then display an error message. While doing a Push
// operation, if the stack is full then display corresponding error message.
